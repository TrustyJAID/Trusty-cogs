...
compliments = [
            ...
            _("If cartoon bluebirds were real, a bunch of them would be sitting on your shoulders singing right now."),
            ...
            _("You may dance like no one's watching, but everyone's watching because you're an amazing dancer!"),
            ...
            _("You're more fun than a ball pit filled with candy. (And seriously, what could be more fun than that?)"),
            _("That thing you don't like about yourself is what makes you so interesting."),
            _("You're wonderful."),
            _("You have cute elbows. For reals! (You're halfway through the list. Don't stop now! You should be giving at least one awesome compliment every day!)"),
            ...
            _("You're inspiring."),
            _("If you were a box of crayons, you'd be the giant name-brand one with the built-in sharpener."),
            ...
            _("If you were a scented candle they'd call it Perfectly Imperfect (and it would smell like summer)."),
    ...
    async def compliment(self, ctx, user : discord.Member=None):
        ...
        if user != None:
            ...
            if user.id == self.bot.user.id:
                ...
                msg = [_(" Hey, I appreciate the compliment! :smile:"), 
